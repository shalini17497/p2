...
//Q2=System Process having medium Priority with Round Robin Algorith Quantum Time=16
//Q3 = System Process having High Priority with Round Robin Algorith Quantum Time=8
